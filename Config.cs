...
namespace CheatyToolsReloaded
{
    ...
    public class SuperCheatyConfig : ModConfig
    {
        ...
        [SeparatePage]
        [Label("Tools")]
        public SuperCheatyConfigTools superCheatyConfigTools = new SuperCheatyConfigTools();
        [SeparatePage]
        [Label("Weapons")]
        public SuperCheatyConfigWeapons superCheatyConfigWeapons = new SuperCheatyConfigWeapons();
        [SeparatePage]
        [Label("Armor")]
        public SuperCheatyConfigArmor superCheatyConfigArmor = new SuperCheatyConfigArmor();
        [SeparatePage]
        [Label("Accessories")]
        public SuperCheatyConfigAccessories superCheatyConfigAccessories = new SuperCheatyConfigAccessories();
        [Label("Tools")]
        [SeparatePage]
        ...
        public class SuperCheatyConfigArmor : ModConfig
        {
            ...
            [Range(0, 100000000)]
            public int TankHealthMultiplier = 4;
            ...
            [Range(0, 100000000)]
            public int MageManaMultiplier = 4;
            ...
            [Range(0, 100000000)]
            public int RangedDamageMultiplier = 100000000;
            ...
            [Range(0, 100000000)]
            public int SummonerMinionMultiplier = 100000000;
        }
        [Label("Accessories")]
        [SeparatePage]
