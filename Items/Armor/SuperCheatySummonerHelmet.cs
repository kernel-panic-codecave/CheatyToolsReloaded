...
namespace CheatyToolsReloaded.Items.Armor
{
    ...
    public class SuperCheatySummonerHelmet : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.rare = 13;
            item.defense = GetInstance<SuperCheatyConfig.SuperCheatyConfigArmor>().SummonerDefense[0];
            item.expert = true;
        ...
        {
            player.setBonus = GetInstance<SuperCheatyConfig.SuperCheatyConfigArmor>().SummonerMinionMultiplier + "x Minion Slots";
