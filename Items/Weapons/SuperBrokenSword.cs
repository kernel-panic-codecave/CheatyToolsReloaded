...
{
    public class SuperBrokenSword : ModItem
    {
        public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Super Broken Sword");
            Tooltip.SetDefault("This is a Super Broken Sword and should only be used by cheaters.");  //The (English) text shown below your weapon's name
        }

        public override void SetDefaults()
        {
            item.crit = 100;
            item.damage = 1000000000;          //The damage of your weapon
